 ...
 * @date 2019/8/2
 */
public class ManagerCooperationDTO {
    /**
     * tbl_cooperation表序列号
     */
    ...
    private List<MerchantTaskInfo> merchantTaskInfos;

    /**
     * 岗位信息
     */
    @ApiModelProperty(value = "岗位信息")
    private List<MerchantTaskInfo> postInfos;
    ...
    public List<MerchantTaskInfo> getPostInfos() {
        return postInfos;
    }

    public void setPostInfos(List<MerchantTaskInfo> postInfos) {
    ...
    public List<MerchantTaskInfo> getMerchantTaskInfos() {
        return merchantTaskInfos;
    }

    public void setMerchantTaskInfos(List<MerchantTaskInfo> merchantTaskInfos) {
        this.merchantTaskInfos = merchantTaskInfos;
    }
